...
(+=.) :: (InCollection col tbl 'OuterQuery, DynamoScalar typ, IsNumber typ)
...
setIfNotExists :: (InCollection col tbl 'OuterQuery, DynamoEncodable typ)
    => Column typ ctyp col -> typ -> Action tbl
...
append :: (InCollection col tbl 'OuterQuery, DynamoEncodable typ)
    => Column [typ] ctyp col -> typ -> Action tbl
append col val =
  case dEncode val of
...
prepend :: (InCollection col tbl 'OuterQuery, DynamoEncodable typ)
    => Column [typ] ctyp col -> typ -> Action tbl
prepend col val =
  case dEncode val of
...
add :: (InCollection col tbl 'OuterQuery, DynamoScalar typ)
    => Column (Set.Set typ) ctyp col -> typ -> Action tbl
add col val = Just $ Add (nameGen col) (dScalarEncode val)

delete :: (InCollection col tbl 'OuterQuery, DynamoScalar typ)
    => Column (Set.Set typ) ctyp col -> typ -> Action tbl
